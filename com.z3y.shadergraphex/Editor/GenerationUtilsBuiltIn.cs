...
{
    static class GenerationUtilsBuiltIn
    {
            ...
            List<Dependency[]> dependencies, string resourceClassName, string assemblyName)
        {
            ...
            string templatePath = "Packages/com.z3y.shadergraphex/hlsl/Templates";
        ...
        {
            // Traverse Graph Data
            vertexNodes = UnityEditor.Graphing.ListPool<AbstractMaterialNode>.Get();
            NodeUtils.DepthFirstCollectNodesFromNode(vertexNodes, masterNode, NodeUtils.IncludeSelf.Include, pass.vertexPorts);

            pixelNodes = UnityEditor.Graphing.ListPool<AbstractMaterialNode>.Get();
